...
export const searchDrives = (starting_point, destination, date, time, amount_of_people, deviationKm, email) => {
  return async dispatch => {
      ...
      for (const key in resData) {
        ...
        newDir
      ), newDriveInformation: {pickUpPoint: pickUpPoint, devationTime: devationTime, amount_of_people: amount_of_people, passangerStartingPoint:starting_point, passangerDestination:destination}
    });
  }
        }
    }
